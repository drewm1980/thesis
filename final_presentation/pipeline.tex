...
\frame{ \frametitle{Centering the test subject's face in the window} 
First prototype: Test image keeps initial alignment, training images
are warped to match.

Second prototyte: Test image is centered in the window using an average
of the alignments from the alignment stage, training images are warped
to match.

Reduces likelihood of background pixels in the frame.

Alignment of test image relative to training images same in both prototypes.
}
