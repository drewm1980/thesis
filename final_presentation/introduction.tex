...
{\em Face Recognition makes the initiation of
...
\item Easier to cut off someone's finger than their head
%STEPH: are you really going to leave this in here???!!! :D
\end{itemize}
}
...
\item System for capturing images of subject under many illuminations
\item Algorithm for aligning test images to gallery
...
\begin{itemize}
%\vspace{0.25in}
\item {\bf Poor alignment}
\item Sufficient training illuminations 
\item Red: Weight of correct subject \newline in linear representation 
\end{itemize}
%\vfill
\\
...
\begin{itemize}
\item {\bf Good alignment}
\item Insufficient training illuminations 
\end{itemize}
\vfill\\
...
\includegraphics[width=0.35\textwidth]{images/shadow_example}
\end{center}\vspace{-5mm}
\begin{itemize}
\item Shadows and Specularities do {\em not} break linear illumination model.
\item They actually {\em help} by encoding 3D and photometric information!
...
\hline
{Our Algorithm} & {\bf 91.4} \% & {\bf 90.3} \% & {\bf 90.2} \% \\
\hline
\end{tabular}
\end{center}
\begin{columns}
...
\item Way too slow for commercial applications in current state 
\end{itemize}
}
