...
Face recognition applications to date have fallen
...
\includegraphics[height=1in]{figures_pami/promo/case1/detector.png}&
\hspace{3mm}
\includegraphics[height=1in]{figures_pami/promo/case1/sci_with_axis_face_case1.png}
\\ \includegraphics[height=1in]{figures_pami/promo/alignment_and_detector.png}&
\hspace{3mm}
\includegraphics[height=1in]{figures_pami/promo/case2/sci_with_axis_face_case2.png}
\\ \includegraphics[height=1in]{figures_pami/promo/case3/alignment.png} &
\hspace{3mm}
\includegraphics[height=1in]{figures_pami/promo/case3/sci_with_axis_face_case3.png}
...
{\small
\begin{tabular}{cccc}
\includegraphics[height=.8in]{figures_pami/L1_cropped} &
\includegraphics[height=.8in]{figures_pami/y_warp_L1} &
\includegraphics[height=.8in]{figures_pami/y_hat_L1} &
\includegraphics[height=.8in]{figures_pami/e_L1} \\
\includegraphics[height=.8in]{figures_pami/L2_cropped} &
\includegraphics[height=.8in]{figures_pami/y_warp_L2} &
\includegraphics[height=.8in]{figures_pami/y_hat_L2} &
\includegraphics[height=.8in]{figures_pami/e_L2} \\
(a) & (b) & (c) & (d)
\end{tabular}
\vspace{0mm}}
...
(d)&(e)&(f)& (g)
\end{tabular}
\vspace{0mm} } \caption{{\bf Region of attraction.} Fraction of
...
\includegraphics[height=1in]{figures_pami/13} \vspace{0in} \\
(a) & (b) & (c) & (d) & (e)\\
...
\includegraphics[height=1in]{figures_pami/3} \vspace{-.1in} \\
...
\begin{figure}
\centering
\includegraphics[height=2.3in]{figures_pami/camera_rig.pdf}
...
\centering
\begin{tabular}{cc}
\includegraphics[height=1.5in]{figures_pami/coverage_experiment_asplode.png} &
\includegraphics[height=1.5in]{figures_pami/final_cvpr_illuminations_asplode.png}  \\
...
\centering
\begin{tabular}{@{}c@{}c@{}}
\includegraphics[height=1.5in]{figures_pami/illum_results/coverage_sunset.pdf} &
\includegraphics[height=1.5in]{figures_pami/illum_results/granularity_sunset.pdf} \\
...
\begin{figure}[h]
\centering
\includegraphics[width=6.3in]{figures_pami/training.png}
\vspace{-2em}
\end{figure}
...
\centering
\begin{tabular}{@{}c@{}c@{}}
\includegraphics[height = 3in]{figures_pami/pami_roc_revision2} & \hspace{2mm}
\includegraphics[height = 3in]{figures_pami/pami_roc2} \\
(a) & \hspace{2mm}(b) \\
\end{tabular}
}
\vspace{-2mm}
