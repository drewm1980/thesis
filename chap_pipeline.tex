...
and show stability to small pose variations.  Large-scale recognition
experiments are postponed to Sections \ref{sec:multipie} and
\ref{sec:own-data}, after we have discussed the issue of illumination in the
next section.
