...
%
Unfortunately, while the work \cite{Wright2009-PAMI} achieves impressive
results, it does not deal with misalignment between the test and training
images, and it requires a rich set of illuminations in the gallery images for
good performance.  We illustrate the compounded effect of both alignment and
illumination with an example in Figure \ref{fig:promo}.  The task is to
identify the girl among 20 subjects. If the test face image, say obtained from
...
\cite{Wright2009-PAMI}.  In this chapter, we examine how to handle alignment
...
\subsection{Contributions} In this chapter, we show how
...
\noindent{\em Organization of this chapter:} In Section \ref{sec:registration},
