...
\title{\vspace{-0.75in} Parallelization of Fast $\ell_1$-Minimization for Face Recognition}
...
{
	\includegraphics[scale=1.2]{figures_ijcb/arrays}
	\label{fig:arrays}
}
\subfigure[The caches on a E5530 CPU]
{
	\includegraphics[scale=1.2]{figures_ijcb/cpu_caches}
	\label{fig:cpu_caches}
}
\subfigure[The caches on a GTX480 GPU]
{
	\includegraphics[scale=1.2]{figures_ijcb/gpu_caches}
...
\begin{figure}
\begin{center}
\includegraphics[width=2.5in]{figures_ijcb/time_vs_matrix_size_constant_tol}
...
\begin{figure}[t!]
\centering
\includegraphics[width=3.3in]{figures_ijcb/alignment_runtime_graph}\vspace{0.06in}
...
\begin{figure}[t!]
\centering
\includegraphics[width=2.5in]{figures_ijcb/speedVsResolution} \vspace{-0.06in}
...
\begin{figure}[t!]
\centering
\includegraphics[width=2.5in]{figures_ijcb/accuracyVsResolution} \vspace{-0.06in}
