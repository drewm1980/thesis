...
\end{center} 
\caption{\small Comparison of $\ell_1$-min runtime vs. dimensions of $A$ on random data.} 
...
\begin{figure}[t!]
\centering
\includegraphics[width=3.3in]{figures_ijcb/alignment_runtime_graph}
...
\begin{figure}[t!]
\centering
\includegraphics[width=2.5in]{figures_ijcb/speedVsResolution} 
...
\begin{figure}[t!]
\centering
\includegraphics[width=2.5in]{figures_ijcb/accuracyVsResolution} 
