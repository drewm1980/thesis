...
\end{equation}
for use in image alignment. This is a slightly more general version of problem \ref{eq:l1min_alignment},
that constraints a subset of the coefficients ($\x$) to be non-negative. 
...
time the step direction is computed results in an algorithm that is has a high
