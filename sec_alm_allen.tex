...
%We refer the interested reader to \cite{YangA2010-pp}
%for a more comprehensive survey of the developments in this area.  

%This section suggests that \emph{Augmented Lagrange Multiplier} (ALM) algorithms
